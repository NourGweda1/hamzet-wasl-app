...
public struct AEOTPView: View {
    ...
    /// A Boolean value that indicates whether the text object disables text copying and,
    /// in some cases, hides the text that the user enters.
    private let isSecureTextEntry: Bool
    /// A Boolean value that used to allow the `AEOTPView` clear the OTP
    /// and set the `AEOTPView` to the default state when you set the OTP Text with Empty Value
    ...
    ///   - isSecureTextEntry: A Boolean value that indicates whether the text object disables text copying and,
    ///    in some cases, hides the text that the user enters.
    ///   - enableClearOTP: A Boolean value that used to allow the `AEOTPView` clear the OTP
    ///    and set the `AEOTPView` to the default state when you set the OTP Text with Empty Value
